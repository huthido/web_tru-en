...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      // Audio chương (tác giả upload / TTS AI) từ cdn Garage + preview giọng
      // dạng data: base64. Thiếu media-src thì rơi về default-src 'self' —
      // <audio> load từ cdn.yeuyeu.net bị chặn (player hiện 0:00, play im lặng).
