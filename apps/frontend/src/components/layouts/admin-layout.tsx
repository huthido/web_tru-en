        ...
        <ProtectedRoute requiredRole={[UserRole.ADMIN]}>
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <div className="flex h-[calc(100vh-64px)]">
                    {/* Admin Sidebar */}
                    <aside
                        className={`bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 h-full ${isSidebarOpen ? 'w-64' : 'w-0 overflow-hidden'
                            }`}
                    >
                    ...
                    {/* Main Content */}
                    <main className={`flex-1 transition-all duration-300 ${isSidebarOpen ? '' : ''}`}>
