            ...
            <div className="min-h-screen bg-surface transition-colors duration-300">
                ...
                <main className="pt-4 md:pt-8 pb-12 min-h-[calc(100vh-60px)] px-4 md:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        ...
                        {/* Doanh thu đã chuyển sang trang Trung tâm Kiếm tiền (/tac-gia/earnings) */}
                                                ...
                                                <div className="p-4 flex flex-col flex-1">
                                                    ...
                                                    <div className="flex flex-col gap-2">
                                                        <div className="grid grid-cols-3 gap-2">
                                                            <Link
                                                                href={`/tac-gia/stories/${story.slug}/chapters`}
                                                            ...
                                                            <Link
                                                                href={`/tac-gia/stories/${story.id}/edit`}
                                                                className="px-3 py-2 bg-surface-container-high hover:bg-surface-container-highest text-on-surface-variant rounded-lg text-xs font-medium transition-colors text-center flex items-center justify-center gap-1"
                                                            >
                                                            ...
                                                            <Link
                                                                href={`/tac-gia/stories/${story.id}/analytics`}
                                                                className="px-3 py-2 bg-surface-container-high hover:bg-surface-container-highest text-on-surface-variant rounded-lg text-xs font-medium transition-colors text-center flex items-center justify-center gap-1"
                                                                title="Xem thống kê"
                                                            >
