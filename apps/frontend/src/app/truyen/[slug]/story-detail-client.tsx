        ...
        <main className="pt-8 pb-12 px-4 md:px-6 max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {/*
                JSON-LD được phát ở server component cha (`page.tsx`) qua <JsonLd>.
                Khối `Book` từng nằm ở đây đã bị gỡ: giữ cả hai thì mỗi trang
                truyện có hai schema Book mâu thuẫn nhau (bản này thiếu `url`,
                lấy `dateModified` từ `updatedAt` thay vì `lastChapterAt`), và
                bản server còn chạy được cho cả crawler không thực thi JS.
              */}
            </div>
          </div>
          <div className="mt-8">
