...
const styles = StyleSheet.create({
    ...
    coverHint: { color: colors.onSurfaceVariant, fontSize: fontSize.sm, fontFamily: 'DMSans_400Regular' },
    coverOverlay: {
    ...
    coverOverlayText: { color: colors.onPrimary, fontSize: fontSize.sm, fontFamily: 'DMSans_500Medium' },
    removeLink: {
        color: colors.error,
    ...
    chipText: { color: colors.onSurface, fontSize: fontSize.sm, fontFamily: 'DMSans_500Medium' },
    ...
    optionLabel: { fontSize: fontSize.md, fontFamily: 'PlusJakartaSans_600SemiBold', color: colors.onSurface },
    optionDesc: { fontSize: fontSize.xs, color: colors.onSurfaceVariant, marginTop: 2, fontFamily: 'DMSans_400Regular' },
    submitBtn: {
